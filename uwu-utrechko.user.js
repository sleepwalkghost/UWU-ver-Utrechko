...
const uwuDefaultSettings = {
  ...
  parametersColors: {
    ...
    heal: ["#008000", "#008000", "#cccccc", "#cccccc"],
  ...
  <div id="parameters-color-settings" class="parameters-color-settings">
    <table class="parameters-color-table">
      ...
      <tbody id="color-settings-body" class="parameters-color-table--body">
        ...
        <tr>
          <td class="parameters-color-table--cell">Целительские умения</td>
          <td class="parameters-color-table--cell"><input type="color" data-param="heal" data-color-type="bar-from"></td>
          <td class="parameters-color-table--cell"><input type="color" data-param="heal" data-color-type="bar-to"></td>
          <td class="parameters-color-table--cell"><input type="color" data-param="heal" data-color-type="bg-from"></td>
          <td class="parameters-color-table--cell"><input type="color" data-param="heal" data-color-type="bg-to"></td>
        </tr>
        <tr>
